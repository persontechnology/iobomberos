...
class CreateVehiculoOperativosTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('vehiculo_operativos', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('vehiculo_operativos');
    }
}
