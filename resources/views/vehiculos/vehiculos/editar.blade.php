@extends('layouts.app',['title'=>'Editar vehiculo'])
        ...
        <div class="card-body">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-control @error('estacion') is-invalid @enderror" name="estacion" id="estacion" >
                                    ...
                                    <option value="{{ $esta->id }}" {{ $esta->id==$vehiculo->estacion->id?'selected':'' }} {{ (old("estacion") == $esta->id ? "selected":"") }} >{{$esta->nombre}}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="form-group row">
                            <label for="name" class="col-md-4 col-form-label text-md-right">Tipo de vehículos<i class="text-danger">*</i></label>
        
                            <div class="col-md-6">
                                @if(count($tipoVehiculos)>0)
                                <select class="form-control @error('tipoVehiculo') is-invalid @enderror" name="tipoVehiculo" id="tipoVehiculo" >
                                    @foreach($tipoVehiculos as $tipoVehiculo)
                                    <option value="{{ $tipoVehiculo->id }}" {{ $tipoVehiculo->id==$vehiculo->tipoVehiculo->id?'selected':'' }} {{ (old("tipoVehiculo") == $tipoVehiculo->id ? "selected":"") }} >{{$tipoVehiculo->nombre}}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="placa" type="text" class="form-control @error('placa') is-invalid @enderror" name="placa" value="{{ old('placa',$vehiculo->placa) }}" required autocomplete="placa" autofocus placeholder="Placa">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="codigo" type="number" class="form-control @error('codigo') is-invalid @enderror" name="codigo" value="{{ old('codigo',$vehiculo->codigo) }}" required autocomplete="codigo" autofocus placeholder="Código">
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="marca" type="text" class="form-control @error('marca') is-invalid @enderror" name="marca" value="{{ old('marca',$vehiculo->marca) }}" required autocomplete="marca" autofocus placeholder="Marca">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="modelo" type="text" class="form-control @error('modelo') is-invalid @enderror" name="modelo" value="{{ old('modelo',$vehiculo->modelo) }}" required autocomplete="modelo" autofocus placeholder="Modelo">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="cilindraje" type="text" class="form-control @error('cilindraje') is-invalid @enderror" name="cilindraje" value="{{old('cilindraje',$vehiculo->cilindraje)}}" placeholder="Cilindraje" required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="anio" type="number" class="form-control @error('anio') is-invalid @enderror" name="anio" value="{{old('anio',$vehiculo->anio)}}" placeholder="Año" required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="motor" type="text" class="form-control @error('motor') is-invalid @enderror" name="motor" value="{{old('motor',$vehiculo->motor)}}" placeholder="Motor" required>
