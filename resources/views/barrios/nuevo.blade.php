...
@section('breadcrumbs', Breadcrumbs::render('nuevoBarrio'))



@section('content')
<form method="POST" action="{{ route('guardarBarrio') }}" id="formNuevoUsuario" >
    @csrf
    <div class="card">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-control @error('parroquia') is-invalid @enderror" name="parroquia" id="parroquia" >
                                    ...
                                    <option value="{{ $esta->id }}" {{ (old("parroquia") == $esta->id ? "selected":"") }} >{{$esta->nombre .' - '. $esta->codigo }}</option>
                                    @endforeach
                                </select>
