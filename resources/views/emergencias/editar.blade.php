@extends('layouts.app')
@section('breadcrumbs', Breadcrumbs::render('editarEmergencia',$eme))
    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                        <form action="{{ route('emergenciaActualizar') }}" method="POST" id="formGuardar">
                            @csrf
                            <input type="hidden" name="emergencia" value="{{ $eme->id }}" required>
                            <label for="nombre">Nombre de emergencia</label>
                            <div class="input-group mb-3">
                                <input type="text" name="nombre" value="{{ old('nombre',$eme->nombre) }}" class="form-control @error('nombre') is-invalid @enderror" placeholder="Ingrese nombre.." aria-label="Recipient's username" aria-describedby="basic-addon2" required>
