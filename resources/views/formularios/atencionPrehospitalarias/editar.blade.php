...
<div class="card">
    ...
    <div class="card-body">
            <form action="{{ route('guardar-atencion') }}" method="POST" >
                @csrf
                    <input type="hidden" value="{{$atencion->id}}" name="formulario">
                    <div class="form-group">
                            <label for="exampleInputEmail1">N° de Registro</label>
                            <input  type="text" class="form-control {{ $errors->has('numero') ? ' is-invalid' : '' }}"  id="numero"  value="{{ old('numero',$atencion->numero) }}" name="numero" >                    
                    ...
                    <div class="form-group">
                        ...
                        <input  type="text" class="form-control {{ $errors->has('ambulancia') ? ' is-invalid' : '' }}"  id="ambulancia"  value="{{ old('ambulancia',$atencion->ambulancia) }}" name="ambulancia" >                    
                        ...
                        <table class="table table-bordered">
                            ...
                            <tr>
                                <th  colspan="2">
                                    ...
                                    <input  type="text"  value="{{ old('nombres') }}" name="nombres" value="{{ old('nombres',$atencion->nombres) }}" class="form-control {{ $errors->has('nombres') ? ' is-invalid' : '' }}" >
                                ...
                                <th><strong>Cédula</strong>
                                    <input  type="text"  value="{{ old('cedula',$atencion->cedula) }}" name="cedula" class="form-control {{ $errors->has('cedula') ? ' is-invalid' : '' }}" >
                                ...
                                <th>
                                    <strong>Edad</strong>
                                    <input  type="text"  value="{{ old('edad',$atencion->edad) }}" name="edad" class="form-control {{ $errors->has('edad') ? ' is-invalid' : '' }}" >
                                    @if ($errors->has('edad'))
                                        <span class="invalid-feedback" role="alert">
                                ...
                                <th>
                                    ...
                                    <div class="form-group row">
                                            ...
                                            <div class="custom-control custom-radio">
                                                <input  type="radio" class="custom-control-input {{ $errors->has('sexo') ? ' is-invalid' : '' }}" value="Hombre" id="Hombre"  value="{{ old('apellidos') }}" name="sexo" {{ $atencion->sexo=='Hombre'?'checked':'' }}   {{ old('sexo')=='Hombre'?'checked':'checked' }}>
                                                <label class="custom-control-label" for="Hombre">Hombre</label>
                                            </div>
                                            <div class="custom-control custom-radio ml-1">
                                                <input type="radio" class="custom-control-input{{ $errors->has('sexo') ? ' is-invalid' : '' }}" value="Mujer" id="Mujer"  value="{{ old('apellidos') }}" name="sexo" {{ $atencion->sexo=='Mujer'?'checked':'' }}  {{ old('sexo')=='Mujer'?'checked':'' }}>
                            ...
                            <tr>
                                <th >
                                    <strong>Hora</strong>
                                    <input type="time"   value="{{ old('horaAtencion',$atencion->horaAtencion) }}" name="horaAtencion" class="form-control {{ $errors->has('horaAtencion') ? ' is-invalid' : '' }}" >
                                ...
                                <th>
                                    ...
                                    <input type="text"  value="{{ old('placa',$atencion->placa) }}" name="placa" class="form-control {{ $errors->has('placa') ? ' is-invalid' : '' }}" >
                                </th>
                            </tr>
                    ...
                    <div class="form-group">
                        ...
                        <textarea  class="form-control {{ $errors->has('diagnostico') ? ' is-invalid' : '' }}"  id="diagnostico"   name="diagnostico">{{ old('diagnostico',$atencion->diagnostico) }}</textarea>                    
                            ...
                            <tr>
                                <th>
                                    <div class="form-group" class="text-center">
                                        ...
                                        <input  type="number" id="pulso"  value="{{ old('pulso',$atencion->pulso) }}" name="pulso"  class="form-control {{ $errors->has('pulso') ? ' is-invalid' : '' }}" >
                                ...
                                <th>
                                    <div class="form-group" class="text-center">
                                        ...
                                        <input  type="number" id="temperatura"  value="{{ old('temperatura',$atencion->temperatura) }}" name="temperatura" value="" class="form-control {{ $errors->has('temperatura') ? ' is-invalid' : '' }}" >
                                ...
                                <th>
                                    <div class="form-group" class="text-center">
                                        ...
                                        <input  type="text" id="presion"  value="{{ old('presion',$atencion->presion) }}" name="presion"  class="form-control {{ $errors->has('presion') ? ' is-invalid' : '' }}" >
                                ...
                                <th>
                                    <div class="form-group" class="text-center">
                                        ...
                                        <input  type="number" id="sp"  value="{{ old('sp',$atencion->sp) }}" name="sp" value="" class="form-control {{ $errors->has('sp') ? ' is-invalid' : '' }}" >
                                        @if ($errors->has('sp'))
                                            <span class="invalid-feedback" role="alert">
                                ...
                                <th>
                                    <div class="form-group" class="text-center">
                                        ...
                                        <input  type="number" id="glasgow"  value="{{ old('glasgow',$atencion->glasgow) }}" name="glasgow" value="" class="form-control {{ $errors->has('glasgow') ? ' is-invalid' : '' }}" >
                            ...
                            <tr>
                                <th>
                                    <div class="form-group" class="text-center">
                                        ...
                                        <div class="custom-control custom-radio">
                                            <input  type="radio" class="custom-control-input {{ $errors->has('reaccionDerecha') ? ' is-invalid' : '' }}" value="RN" id="RN" name="reaccionDerecha" {{$atencion->reaccionDerecha=='RN'?'checked':''}}  {{ old('reaccionDerecha')=='RN'?'checked':'' }}>
                                            <label class="custom-control-label" for="RN">RN</label>
                                        </div>
                                        <div class="custom-control custom-radio ml-1">
                                            <input type="radio" class="custom-control-input{{ $errors->has('reaccionDerecha') ? ' is-invalid' : '' }}" value="RL" id="RL" name="reaccionDerecha" {{$atencion->reaccionDerecha=='RL'?'checked':''}} {{ old('reaccionDerecha')=='RL'?'checked':'' }}>
                                            <label class="custom-control-label" for="RL">RL</label>
                                        </div> 
                                        <div class="custom-control custom-radio">
                                                <input type="radio" class="custom-control-input {{ $errors->has('reaccionDerecha') ? ' is-invalid' : '' }}" value="RR" id="RR" name="reaccionDerecha"  {{$atencion->reaccionDerecha=='RR'?'checked':''}}  {{ old('reaccionDerecha')=='RR'?'checked':'' }}>
                    ...
                    <div class="row">
                        <div class="col-sm-5">
                            ...
                            <select  class="form-control {{ $errors->has('clinica') ? ' is-invalid' : '' }}"   name="clinica" id="clinica" >
                                ...
                                <option value="{{$clinica->id}}" {{$atencion->clinica_id==$clinica->id ? "selected":""}} {{ (old("clinica") == $clinica->id ? "selected":"") }}>{{$clinica->nombre}}</option>                            
                                @endforeach
                        ...
                        <div class="col-sm-4">
                            <div class="form-group"  class="text-center">
                                ...
                                <input type="text" id="resposableRecibe"  value="{{ old('resposableRecibe',$atencion->resposableRecibe) }}" name="resposableRecibe" class="form-control {{ $errors->has('resposableRecibe') ? ' is-invalid' : '' }}" >
                        ...
                        <div class="col-sm-3">
                            <div class="form-group"  class="text-center">
                                ...
                                <input type="time" id="horaEntrada"  value="{{ old('horaEntrada',$atencion->horaEntrada) }}" name="horaEntrada"  class="form-control {{ $errors->has('horaEntrada') ? ' is-invalid' : '' }}" >
