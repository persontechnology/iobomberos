@extends('layouts.app',['title'=>'Clinicas'])

@section('breadcrumbs', Breadcrumbs::render('clinicas'))
...
@prepend('linksPie')
    <script>
        ...
        function eliminar(arg){
            ...
            swal({
                title: "¿Estás seguro?",
                text: "Que desea eliminar esta clínica !",
                type: "error",
            ...
            function(){
                ...
                $.post( "{{ route('eliminarClinica') }}", { clinica: $(arg).data('id') })
                .done(function( data ) {
                    if(data.success){
