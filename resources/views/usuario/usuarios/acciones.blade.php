<div class="btn-group btn-group-sm" role="group" aria-label="Basic example">
    ...
    <a href="{{ route('informacionUsuario',$user->id) }}" class="btn btn-primary"  data-toggle="tooltip" data-placement="top" title="Información {{ $user->name }}">
        <i class="fas fa-eye"></i>
    </a>

    <a href="{{ route('editarRolUsuario',$user->id) }}" class="btn btn-dark"  data-toggle="tooltip" data-placement="top" title="Roles de {{ $user->name }}">
